...
![KubeMind 知识中心界面预览](111.jpg)

## 项目定位

在复杂的 Kubernetes 生产环境中，故障定位往往需要同时查看监控指标、日志、告警、历史案例和操作手册。KubeMind 希望将这些信息集中到一个 AI WorkBench 中，让运维人员可以更快完成：
